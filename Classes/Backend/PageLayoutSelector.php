...
namespace SimpleTYPO3\DocumentNodeType\Backend;
 ...
 * }
 */
class PageLayoutSelector extends \FluidTYPO3\Fluidpages\Backend\PageLayoutSelector{
	...
	protected $templates = array(
		...
		'field' => '<label class="col-xs-6 col-sm-4 col-md-3 img-thumbnail %s" style="padding-top:15px; padding-bottom:15px;cursor: pointer; ">
						<div class="media">
		...
		'title' => '<label class="col-xs-12 img-thumbnail"><h4 class="small">%s: %s</h4></label>'
	);
